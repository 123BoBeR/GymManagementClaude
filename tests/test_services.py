...
class TestMemberService:
    ...
    def test_fresh_subscription_end_monthly(self, db, setup):
        from services import SubscriptionFactory
        assert (MemberService.fresh_subscription_end('monthly')
                == SubscriptionFactory.create('monthly').extend(None))
